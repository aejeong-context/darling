...
=== Wish 수정 (Status)
==== Request Fields
include::{snippets}/wish-update-status/path-parameters.adoc[]

==== HTTP request
include::{snippets}/wish-update-status/http-request.adoc[]

==== HTTP response
include::{snippets}/wish-update-status/http-response.adoc[]
